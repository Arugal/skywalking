 ...
 */
@Slf4j
public class PagePathIdExchanger implements IdExchanger<BrowserErrorLogDecorator> {
    ...
    @Override
    public boolean exchange(BrowserErrorLogDecorator standardBuilder, int serviceId) {
