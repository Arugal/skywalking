...
package org.apache.skywalking.oap.server.recevier.browser.provider.parser.performance.listener;
 ...
 * @author zhangwei
 */
public interface BrowserPerfDataListener {

    void build();

    void parse(BrowserPerfDataDecorator decorator, BrowserPerfDataCoreInfo coreInfo);
}
