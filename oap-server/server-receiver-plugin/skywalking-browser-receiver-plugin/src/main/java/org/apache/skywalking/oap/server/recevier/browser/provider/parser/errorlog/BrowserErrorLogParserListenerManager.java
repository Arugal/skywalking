 ...
 * @author zhangwei
 */
public class BrowserErrorLogParserListenerManager {

    @Getter
    private List<BrowserErrorLogListenerFactory> factories;

    public BrowserErrorLogParserListenerManager() {
        this.factories = new LinkedList<>();
    }

    public void add(BrowserErrorLogListenerFactory factory) {
