...
source
    : SRC_ALL | SRC_SERVICE | SRC_DATABASE_ACCESS | SRC_SERVICE_INSTANCE | SRC_ENDPOINT |
      ...
      SRC_BROWSER_SERVICE_PERF_DETAIL | SRC_BROWSER_SERVICE_PAGE_PATH_PERF_DETAIL | // Browser perf detail source
      SRC_BROWSER_SERVICE_VERSION_PERF_DETAIL | SRC_BROWSER_SERVICE_VERSION_PAGE_PATH_PERF_DETAIL
    ;
