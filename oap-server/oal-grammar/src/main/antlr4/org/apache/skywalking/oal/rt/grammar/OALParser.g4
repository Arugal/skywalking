...
source
    : SRC_ALL | SRC_SERVICE | SRC_DATABASE_ACCESS | SRC_SERVICE_INSTANCE | SRC_ENDPOINT |
      ...
      SRC_BROWSER_PERF_DETAIL | SRC_BROWSER_PAGE_PATH_PERF_DETAIL | // Browser perf detail source
      SRC_BROWSER_SINGLE_VERSION_PERF_DETAIL | SRC_BROWSER_SINGLE_VERSION_PAGE_PATH_PERF_DETAIL
    ;
